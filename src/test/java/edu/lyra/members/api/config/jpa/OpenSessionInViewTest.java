 ...
 * paths, with {@code LazyInitializationException}. This test makes the dependency explicit and the setting deliberate,
 * rather than inherited from a Spring Boot default that could change.
 *
